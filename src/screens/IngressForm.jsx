  ...
  const ingressForPlate = (plate) => {
    if (plate == "")
      return Swal.fire({
        position: "top-center",
        icon: "error",
        title: `${selected === "DNI" ? "el DNI" : "La placa"} no puede estar vacia`,
        showConfirmButton: false,
        timer: 1000,
      });
    ...
    if (validationPlate === undefined)
      return Swal.fire({
        position: "top-center",
        icon: "error",
        title: `${selected === "DNI" ? "El usuario no existe" : "La placa no existe"}`,
        showConfirmButton: false,
        timer: 1000,
      });
  ...
  return (
    <form className="flex flex-col items-center gap-5">
      ...
      <Input
        ...
        name="idPlate"
        type="text"
        label={selected === "DNI" ? "Identificación del usuario" : "Placa del vehiculo"}
        placeholder="Ingresa el DNI o la placa del vehiculo"
        value={idPlate}
